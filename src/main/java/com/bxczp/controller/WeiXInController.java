...
import com.bxczp.properties.WeixinpayProperties;
...
public class WeiXInController {
    ...
    public ModelAndView pay(Order order, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (DeviceUtil.isMobileDevice(userAgent)) { // 移动设备
            ...
            if (StringUtil.isNotEmpty(weixinpayProperties.getSub_mch_id())) {
                map.put("sub_mch_id", weixinpayProperties.getSub_mch_id());
            }
